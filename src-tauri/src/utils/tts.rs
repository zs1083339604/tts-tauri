...
impl TTS {
    fn num_to_str(&self, num: &str) -> String {
        ...
        let mut num_str = num.trim_matches(|c| c == ' ' || c == '"' || c == '=' || c == '\'').to_string();
    ...
    fn convert_to_ssml_text(&self, voice: &str, text: &str, pitch: &str, rate: &str, volume: &str) -> String {
        format!(
    ...
    pub fn convert_to_ssml_websocket_string(&self, request_id: &str, voice: &str, msg: &str, pitch: &str, rate: &str, volume: &str) -> String {
        format!(
    ...
    pub fn generate_sec_ms_gec(&self) -> Result<CustomResult, CustomResult> {
        ...
        let str_to_hash = format!("{}{}", self.num_to_str(&ticks_int.to_string()), "6A5AA1D4EAFF4E9FB37E23D68491D6F4");
